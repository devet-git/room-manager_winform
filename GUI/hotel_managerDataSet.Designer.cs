...
namespace GUI {
    ...
    public partial class hotel_managerDataSet : global::System.Data.DataSet {
        ...
        public partial class roomsDataTable : global::System.Data.TypedTableBase<roomsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public roomsRow AddroomsRow(string code, int rate, int surcharge, string type, string description) {
        ...
        public partial class roomsRow : global::System.Data.DataRow {
            ...
            public int rate {
                get {
                    return ((int)(this[this.tablerooms.rateColumn]));
                }
                set {
            ...
            public int surcharge {
                get {
                    return ((int)(this[this.tablerooms.surchargeColumn]));
                }
                set {
                    this[this.tablerooms.surchargeColumn] = value;
                }
            }
...
namespace GUI.hotel_managerDataSetTableAdapters {
    ...
    public partial class roomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[rooms] WHERE (([id] = @Original_id) AND ([code] = @Original_co" +
                "de) AND ([rate] = @Original_rate) AND ([surcharge] = @Original_surcharge) AND ([" +
                "type] = @Original_type))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[rooms] ([code], [rate], [surcharge], [type], [description]) VA" +
                "LUES (@code, @rate, @surcharge, @type, @description);\r\nSELECT id, code, rate, su" +
                "rcharge, type, description FROM rooms WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[rooms] SET [code] = @code, [rate] = @rate, [surcharge] = @surcharge, [type] = @type, [description] = @description WHERE (([id] = @Original_id) AND ([code] = @Original_code) AND ([rate] = @Original_rate) AND ([surcharge] = @Original_surcharge) AND ([type] = @Original_type));
SELECT id, code, rate, surcharge, type, description FROM rooms WHERE (id = @id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::GUI.Properties.Settings.Default.hotel_managerConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, code, rate, surcharge, type, description FROM dbo.rooms";
        ...
        public virtual int Fill(hotel_managerDataSet.roomsDataTable dataTable) {
        ...
        public virtual hotel_managerDataSet.roomsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotel_managerDataSet.roomsDataTable dataTable = new hotel_managerDataSet.roomsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotel_managerDataSet.roomsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_code, int Original_rate, int Original_surcharge, string Original_type) {
            ...
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_surcharge));
        ...
        public virtual int Insert(string code, int rate, int surcharge, string type, string description) {
            if ((code == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(surcharge));
            if ((type == null)) {
        ...
        public virtual int Update(string code, int rate, int surcharge, string type, string description, int Original_id, string Original_code, int Original_rate, int Original_surcharge, string Original_type, int id) {
            if ((code == null)) {
                throw new global::System.ArgumentNullException("code");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(surcharge));
            if ((type == null)) {
                throw new global::System.ArgumentNullException("type");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_rate));
            this.Adapter.UpdateCommand.Parameters[8].Value = ((int)(Original_surcharge));
            if ((Original_type == null)) {
                throw new global::System.ArgumentNullException("Original_type");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string code, int rate, int surcharge, string type, string description, int Original_id, string Original_code, int Original_rate, int Original_surcharge, string Original_type) {
            return this.Update(code, rate, surcharge, type, description, Original_id, Original_code, Original_rate, Original_surcharge, Original_type, Original_id);
        }
    }
