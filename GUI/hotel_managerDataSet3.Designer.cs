...
namespace GUI {
    ...
    public partial class hotel_managerDataSet3 : global::System.Data.DataSet {
        ...
        public partial class roomsDataTable : global::System.Data.TypedTableBase<roomsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public roomsRow AddroomsRow(string id, int rate, int surcharge, string description) {
...
namespace GUI.hotel_managerDataSet3TableAdapters {
    ...
    public partial class roomsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[rooms] WHERE (([id] = @Original_id) AND ([rate] = @Original_ra" +
                "te) AND ([surcharge] = @Original_surcharge))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[rooms] SET [id] = @id, [rate] = @rate, [surcharge] = @surcharge, [description] = @description WHERE (([id] = @Original_id) AND ([rate] = @Original_rate) AND ([surcharge] = @Original_surcharge));
SELECT id, rate, surcharge, description FROM rooms WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, rate, surcharge, description FROM dbo.rooms";
        ...
        public virtual int Fill(hotel_managerDataSet3.roomsDataTable dataTable) {
        ...
        public virtual hotel_managerDataSet3.roomsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            hotel_managerDataSet3.roomsDataTable dataTable = new hotel_managerDataSet3.roomsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(hotel_managerDataSet3.roomsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_id, int Original_rate, int Original_surcharge) {
            if ((Original_id == null)) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_surcharge));
        ...
        public virtual int Update(string id, int rate, int surcharge, string description, string Original_id, int Original_rate, int Original_surcharge) {
            if ((id == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_rate));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_surcharge));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int rate, int surcharge, string description, string Original_id, int Original_rate, int Original_surcharge) {
            return this.Update(Original_id, rate, surcharge, description, Original_id, Original_rate, Original_surcharge);
        }
    }
